...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> authServiceHandler(HastaneManagerException hastaneException){
        return new ResponseEntity<>(createErrorMessage(hastaneException,hastaneException.getErrorType()),
                hastaneException.getErrorType().getHttpStatus());
    }
